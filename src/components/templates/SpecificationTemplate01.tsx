...
interface SpecificationTemplate01Props {
  panel?: Panel;
...
// Loads an image and resolves both its data URL and its natural dimensions
...
export async function createSpecificationTemplate01Pdf(
...
export default function SpecificationTemplate01({
  panel,
  qrImageSrc,
  isFree = false,
  onBack,
